...
var {isUserExists, getUsers, createUser}=require('../database/queries/queries.js');
        ...
        bcrypt.hash(req.body.password, 10, async (err, hashedPassword) => {
            if (err) {
              res.status(404).json({"message":"error has occured"});
                ...
                const createdUser=await createUser(req.body.firstname,req.body.lastname,req.body.username,hashedPassword,req.body.email)
